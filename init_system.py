...
keyboard.create_product(
    ...
    image="https://www.linkpicture.com/q/corsair-K70-RGB-MK2-01.jpg",
    qty=10,
    version="MK.2",
    type="Mechanical",
...
keyboard.create_product(
    ...
    image="https://www.linkpicture.com/q/61WRmsMvbRL.jpg",
    qty=25,
    version="V1",
    type="Membrane",
    switches="N/A",
...
keyboard.create_product(
    ...
    image="https://www.linkpicture.com/q/png-transparent-computer-keyboard-computer-mouse-logitech-pro-gaming-keyboard-920-008290-gaming-keypad-logitech-pro-mechanical-gaming-keyboard-us-international-keyboard-player-electronics-computer-rem.png",
    qty=5,
    version="V3",
    type="Mechanical",
...
keyboard.create_product(
    ...
    image="https://www.linkpicture.com/q/png-clipart-computer-keyboard-cherry-corsair-k63-wireless-mechanical-gaming-keyboard-gaming-keypad-cooler-master-cherry-computer-keyboard-fruit-nut-removebg-preview.png",
    qty=15,
    version="V2",
    type="Mechanical",
...
keyboard.create_product(
    ...
    image="https://www.linkpicture.com/q/l20gt01_1.jpg",
    qty=20,
    version="V1",
    type="Mechanical",
